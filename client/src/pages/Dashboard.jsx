...
export default function Dashboard() {
  ...
  return (
    <div className="dashboard-luxury-container">
      ...
      {/* 2. KPI Highlights Grid (2x2 on mobile, 4 columns on desktop with generous breathing space) */}
      <section className="kpi-luxury-grid grid grid-cols-2 lg:grid-cols-4 gap-3.5 sm:gap-5 my-3 sm:my-6">
